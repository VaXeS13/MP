...
namespace MP.Migrations
{
    ...
    [Migration("20251007041610_AddItemsAndItemSheets")]
    partial class AddItemsAndItemSheets
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MP.Domain.Settlements.SettlementItem", b =>
                {
                    ...
                    b.Property<Guid>("RentalItemId")
                        .HasColumnType("uniqueidentifier")
                        .HasComment("ID przedmiotu z wynajmu");
                    ...
                    b.HasIndex("RentalItemId")
                        .HasDatabaseName("IX_SettlementItems_RentalItemId");
            ...
            modelBuilder.Entity("MP.Domain.Settlements.SettlementItem", b =>
                {
                    b.HasOne("MP.Domain.Rentals.RentalItem", "RentalItem")
                        .WithMany()
