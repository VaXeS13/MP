...
namespace MP.Migrations
{
    ...
    [Migration("20250830164114_AddedRentalAggregate")]
    partial class AddedRentalAggregate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MP.Domain.Booths.Booth", b =>
                {
                    ...
                    b.Property<int>("Type")
                        .HasColumnType("int")
                        .HasComment("Typ stanowiska (SelfPricing/ShopPricing)");

                    b.HasKey("Id");

                    b.HasIndex("Number")
                        .IsUnique()
                        .HasDatabaseName("IX_Booths_Number");
            ...
            modelBuilder.Entity("MP.Domain.Rentals.Rental", b =>
                {
                    ...
                    b.HasIndex("StartedAt", "CompletedAt")
            ...
            modelBuilder.Entity("MP.Domain.Booths.Booth", b =>
                {
                    b.OwnsOne("MP.Domain.Booths.Commission", "Commission", b1 =>
                        {
