...
namespace MP.Migrations
{
    ...
    [Migration("20250928151739_AddStripeAndPayPalTransactionTables")]
    partial class AddStripeAndPayPalTransactionTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MP.Domain.Payments.PaymentProviderConfiguration", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("ConfigurationData")
                        ...
                        .HasColumnType("nvarchar(max)")
                        .HasDefaultValue("{}")
                        .HasComment("Dane konfiguracyjne w formacie JSON");
                    ...
                    b.Property<string>("DisplayName")
                        ...
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
                        .HasComment("Nazwa wyświetlana dostawcy");
                    ...
                    b.Property<bool>("IsEnabled")
                        ...
                        .HasColumnType("bit")
                        .HasDefaultValue(false)
                        .HasComment("Czy dostawca jest włączony");
                    ...
                    b.Property<decimal>("MaxAmount")
                        ...
                        .HasColumnType("decimal(18,2)")
                        .HasDefaultValue(0m)
                        .HasComment("Maksymalna kwota transakcji (0 = brak limitu)");
                    ...
                    b.Property<string>("Metadata")
                        ...
                        .HasColumnType("nvarchar(max)")
                        .HasDefaultValue("{}")
                        .HasComment("Dodatkowe metadane w formacie JSON");

                    b.Property<decimal>("MinAmount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(18,2)")
                        .HasDefaultValue(1.00m)
                        .HasComment("Minimalna kwota transakcji");

                    b.Property<int>("Priority")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(100)
                        .HasComment("Priorytet wyświetlania (niższy = wyższy priorytet)");

                    b.Property<string>("ProviderId")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                        .HasComment("Identyfikator dostawcy płatności");
                    ...
                    b.Property<string>("SupportedCurrencies")
                        ...
                        .HasColumnType("nvarchar(500)")
                        .HasDefaultValue("PLN")
                        .HasComment("Obsługiwane waluty oddzielone przecinkiem");
                    ...
                    b.HasIndex("IsEnabled")
                        .HasDatabaseName("IX_PaymentProviderConfigurations_IsEnabled");

                    b.HasIndex("TenantId", "ProviderId")
                        .IsUnique()
                        .HasDatabaseName("IX_PaymentProviderConfigurations_TenantId_ProviderId")
                        .HasFilter("[TenantId] IS NOT NULL");

                    b.HasIndex("TenantId", "IsEnabled", "Priority")
                        .HasDatabaseName("IX_PaymentProviderConfigurations_TenantId_IsEnabled_Priority");

                    b.ToTable("AppPaymentProviderConfigurations", (string)null);
                });
            ...
            modelBuilder.Entity("MP.Domain.Rentals.RentalItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppRentalItems", (string)null);
                });
            ...
            modelBuilder.Entity("MP.Domain.FloorPlans.FloorPlanBooth", b =>
                {
                    b.HasOne("MP.Domain.Booths.Booth", null)
                        .WithMany()
