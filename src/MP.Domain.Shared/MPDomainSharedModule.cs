...
public class MPDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        MPGlobalFeatureConfigurator.Configure();
        MPModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<MPDomainSharedModule>();
        });
        ...
        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                ...
                .AddVirtualJson("/Localization/MP");

            options.DefaultResourceType = typeof(MPResource);
            ...
            options.Languages.Add(new LanguageInfo("pl-PL", "pl-PL", "polski (Polska)")); 

        });
        
        Configure<AbpExceptionLocalizationOptions>(options =>
        {
            options.MapCodeNamespace("MP", typeof(MPResource));
        });
    }
}
