...
import type { CreateFloorPlanElementDto, FloorPlanElementDto, GetFloorPlanElementListDto, UpdateFloorPlanElementDto } from '../floor-plans/models';
...
export class FloorPlanElementService {
  ...
  create = (floorPlanId: string, input: CreateFloorPlanElementDto, config?: Partial<Rest.Config>) =>
    this.restService.request<any, FloorPlanElementDto>({
      method: 'POST',
      url: `/api/app/floor-plan-element/floor-plan/${floorPlanId}`,
      body: input,
    },
